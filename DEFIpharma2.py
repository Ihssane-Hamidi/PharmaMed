...
# =========================
@st.cache_data
def load_csv_from_drive(drive_id, sep="\t"):
    url = f"https://drive.google.com/uc?export=download&id={drive_id}"
    return pd.read_csv(url, sep=sep, engine="python")

# =========================
# IDs Google Drive des fichiers CSV
# =========================
ID_COMPACT = "TON_ID_COMPACT"  # remplacer par l'ID de Compact_DATA_DEFIS_CIP_officielle.csv
ID_BIG10 = "TON_ID_BIG10"      # remplacer par l'ID de Big10_DATA_DEFIS_CIP_officielle.csv
...
# Exemple Streamlit
# =========================
st.title("DEFIS Pharma")
st.write("Aperçu des données Compact :")
st.dataframe(df.head())
st.write("Aperçu des données Big10 :")
